...
def testIntent():
    ...
    # verbdoubling_without_object
    print("[TEST] verbdoubling_without_object")
    inputLIST = ['雨下了兩次','張三哭了兩次','張三哭可能哭了兩次']
    testLoki(inputLIST, ['verbdoubling_without_object'])
    print("")

    # verboriginal
    print("[TEST] verboriginal")
    inputLIST = ['他看電視三小時','張三罵李四兩次','李四騎那匹馬兩次']
    testLoki(inputLIST, ['verboriginal'])
    print("")

    # verbdoubling_le
    print("[TEST] verbdoubling_le")
    inputLIST = ['王小明開車開了兩次','王小明騎那匹馬騎了兩次','李四騎那匹馬騎了兩個小時','王小明看電視看了三個小時']
    testLoki(inputLIST, ['verbdoubling_le'])
    print("")

    # verbdoubling_movement
    print("[TEST] verbdoubling_movement")
    inputLIST = ['李四睡了兩次','張三罵了李四兩次','張三罵李四罵了兩次']
    testLoki(inputLIST, ['verbdoubling_movement'])
    print("")
