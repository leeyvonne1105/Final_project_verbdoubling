...
"""
    Loki module for verbdoubling_le
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("王小明開車開了兩次", "王小明開車開了兩次", [], {}, {})
    pprint(resultDICT)